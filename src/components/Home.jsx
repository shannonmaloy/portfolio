                    ...
                    <div className="row">
                        ...
                        <div className="slider-text-inner js-fullheight">
                          ...
                          <h2>I'm Shannon Maloy - a successful Realtor with an education in Biological Engineering turned full-stack Software Engineer.  I am a problem solver by nature and thrive in the victory of achieving a goal.</h2>
                            <p><a href="https://drive.google.com/file/d/1XJXv1LaOjeyUlvnCIayBLKRDi05G3Tj3/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-learn">View Resume <em className="icon-download4" /></a></p>
                            </div>
                        </div>
                        </div>
                    </div>
